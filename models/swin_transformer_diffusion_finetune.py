...
class SwinTransformer_Diffusion_Finetune(nn.Module):
    r""" Swin Transformer
    ...
    def __init__(self, finetune_mode='stage1', is_efficient_finetune=False, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
