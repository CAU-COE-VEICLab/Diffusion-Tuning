...
class Adapter_SMT_Diffusion_Finetune(nn.Module):
    def __init__(self, add_extra_adapter=True, finetune_mode='stage1', is_efficient_finetune=False,
                 patch_size=4,
                 model_style='trans',
...
def test(num_classes: int = 1000, **kwargs):
    ...
    model = Adapter_SMT_Diffusion_Finetune(
        ...
        pretrain_image_size=224, patch_size=4,
        model_style='trans',
