...
class BasicLayer(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
                 ...
                 fused_window_process=False, model_style='trans', training_mode='tfs', use_layerscales=False, layer_scale_init_value=1e-6):
...
class Adapter_SwinTransformer(nn.Module):
    ...
    def __init__(self, is_efficient_finetune=False, pretrain_image_size=224,
